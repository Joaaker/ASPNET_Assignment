...
public class ResponseResult<T> : ResponseResult, IResponseResult<T>
{
    ...
    //Generated by ChatGPT 03-mini-high - It returns a type-safe error response. Used in catches for methods with return type Task<IResponseResult<IEnumerable<Model>>>
